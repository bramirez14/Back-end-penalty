...
router.put(
  ...
  usersController.pagoGasto
);
router.put(
  "/pagofinal/:id",
  uploadpdf.single("file"),
  usersController.pagofinalGasto
); //pdf final
...
router.put(
  "/pagofinal/kilometros/:id",
  uploadpdf.single("file"),
  usersController.pagokmfinal
); //pdf final
...
router.put(
  "/pagofinal/sueldo/:id",
  uploadpdf.single("file"),
  usersController.sueldopdffinal
); //pdf final
...
//pdf
router.post(
  "/editar/pdf/gastos/:id",
  uploadpdf.single("file"),
  usersController.editarGastoPDF
);

//pdfinal
router.post(
  "/editar/pdfinal/gastos/:id",
  uploadpdf.single("file"),
  usersController.editarGastoPDFinal
);

//pdf Orden de pago final
router.post(
  "/editar/pdfpagofinal/gastos/:id",
  uploadpdf.single("file"),
  usersController.editarGastoPDFOpFinal
);
...
router.post(
  "/editar/pdf/km/:id",
  uploadpdf.single("file"),
  usersController.editarKmPDFproveedores
);

//pdfinal
router.post(
  "/editar/pdfinal/km/:id",
  uploadpdf.single("file"),
  usersController.editarKmPDFpago
);

//pdf Orden de pago final
router.post(
  "/editar/pdfpagofinal/km/:id",
  uploadpdf.single("file"),
  usersController.editarKmPDFOpFinal
);
